...
function downloadChecklist() {
    ...
    try {
        ...
        doc.text('Website Launch Checklist', 105, yPos, { align: 'center' });
        yPos += 10;

        doc.setFontSize(10);
        doc.setFont(undefined, 'normal');
        doc.setTextColor(100);
        doc.text('Your personalized checklist for launching a successful website', 105, yPos, { align: 'center' });
        yPos += 15;
        ...
        Object.keys(tiers).forEach(tierKey => {
            ...
            doc.setFontSize(14);
            doc.setFont(undefined, 'bold');
            doc.setTextColor(...tierColors[tierKey]);
            doc.text(tier.title, margin, yPos);
            yPos += 8;
            ...
            tier.sections.forEach(section => {
                ...
                section.items.forEach(item => {
                    ...
                    const isCompleted = savedProgress[item.id];
                    ...
                    doc.text(titleLines, margin + 7, yPos);
        ...
        doc.setFont(undefined, 'normal');
        doc.text('Generated by Small Business Website Starter Kit', 105, yPos, { align: 'center' });
        doc.textWithLink('www.sbwsk.io', 105, yPos + 5, { align: 'center', url: 'https://www.sbwsk.io' });

        // Save the PDF
        doc.save('website-launch-checklist.pdf');
        showAlert('PDF downloaded! Check your downloads folder.', 'success', 'successMessage');
    } catch (error) {
        ...
        showAlert('Checklist downloaded as text file.', 'success', 'successMessage');
    }
}
